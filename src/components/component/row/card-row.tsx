...
export const CardRow: CmsLayoutComponent<
  LayoutProps<typeof CardRowLayoutProps>
> = ({ layoutProps, children }) => {
  ...
  return (
    <Card
      cardColor={color}
      className={`row vb:row:Card ${additionalClasses.join(" ")}`}
      direction={colOrder == "reversed" ? "row_small_reversed" : "row"}
    >
      {children}
    </Card>
  );
